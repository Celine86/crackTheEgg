...
/** @type {string} */
const CACHE_VERSION = '1777993034|8084748670';
/** @type {string} */
const CACHE_PREFIX = 'crackTheEgg-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'crackTheEgg.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["crackTheEgg.html","crackTheEgg.js","crackTheEgg.offline.html","crackTheEgg.icon.png","crackTheEgg.apple-touch-icon.png","crackTheEgg.audio.worklet.js","crackTheEgg.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["crackTheEgg.wasm","crackTheEgg.pck"];
